...
// Mock AI response function - this would connect to an actual API in production
...
3. Two characters who depend on each other discover they have fundamentally incompatible goals, requiring one to sacrifice their dreams for the other to succeed.`,
    ...
    return responses[prompt.purpose] || "I'm not sure how to help with that. Could you try a different prompt?";
  } catch (error) {
